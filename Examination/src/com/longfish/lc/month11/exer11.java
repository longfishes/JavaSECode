...
public class exer11 {
    ...
    public int maximumMinutes(int[][] grid){
        int count = 50;
        if (start(grid,count)==1)return 1000000000;
        for(;;){
            if (start(grid,count)>=0)return count;
            else count--;
            if (count<0)return -1;
        }
    }

    public int start(int[][] grid,int x) {
...
//        System.out.println();
        ...
        if (countFire==countPerson)return 1;
        return countFire-countPerson;
    }

    @Test
    public void test(){
        System.out.println(maximumMinutes(new int[][]{{0, 2, 0, 0, 0, 0, 0},
                {0, 0, 0, 2, 2, 1, 0}, {0, 2, 0, 0, 1, 2, 0},
                {0, 0, 2, 2, 2, 0, 2}, {0, 0, 0, 0, 0, 0, 0}}));
    }
    @Test
    public void test2(){
        System.out.println(maximumMinutes(new int[][]{{0,0,0,0},{0,1,2,0},{0,2,0,0}}));
    }

    @Test
    public void test3(){
        System.out.println(maximumMinutes(new int[][]{{0,0,0},{2,2,0},{1,2,0}}));
    }
}
